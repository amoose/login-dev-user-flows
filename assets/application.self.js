...
var DateFormatter = function (_DelimitedTextFormatt) {
  ...
  function DateFormatter() {
    ...
    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(DateFormatter).call(this, '/'));
...
var NumericFormatter = function (_Formatter) {
  ...
  function NumericFormatter() {
    ...
    return _possibleConstructorReturn(this, Object.getPrototypeOf(NumericFormatter).apply(this, arguments));
  }
  ...
  _createClass(NumericFormatter, [{
    ...
    value: function isChangeValid(change, error) {
      if (DIGITS_PATTERN.test(change.inserted.text)) {
        return _get(Object.getPrototypeOf(NumericFormatter.prototype), 'isChangeValid', this).call(this, change, error);
      }
      return false;
    }
  }]);
...
var PersonalKeyFormatter = function (_DelimitedTextFormatt) {
  ...
  function PersonalKeyFormatter() {
    ...
    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(PersonalKeyFormatter).call(this, '-', true));
  ...
  _createClass(PersonalKeyFormatter, [{
    ...
    value: function isChangeValid(change, error) {
      if (DIGITS_PATTERN.test(change.inserted.text)) {
        return _get(Object.getPrototypeOf(PersonalKeyFormatter.prototype), 'isChangeValid', this).call(this, change, error);
      }
...
var ZipCodeFormatter = function (_DelimitedTextFormatt) {
  ...
  function ZipCodeFormatter() {
    ...
    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ZipCodeFormatter).call(this, '-', true));
  ...
  _createClass(ZipCodeFormatter, [{
    ...
    value: function isChangeValid(change, error) {
      if (DIGITS_PATTERN.test(change.inserted.text)) {
        return _get(Object.getPrototypeOf(ZipCodeFormatter.prototype), 'isChangeValid', this).call(this, change, error);
      }
